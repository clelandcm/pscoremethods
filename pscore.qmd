...
# [Checking covariate balance](https://cran.r-project.org/web/packages/MatchIt/vignettes/assessing-balance.html)

## Subclassification 
```{r}
summary(mSC, addlvariables = ~ I(W1^2) + W1:W2)
```

## Matching
```{r}
summary(mF, addlvariables = ~ I(W1^2) + W1:W2)
```
